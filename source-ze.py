...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙰𝚁𝙺� 🔱",url="t.me//k_40_x")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @/k_40_x*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙰𝚁𝙺� 🔱",url="t.me//k_40_x")
	p3.add(p5)
...
- - - - - - - - - - - - - 
@k_40_x*""",parse_mode="markdown",reply_markup=p3)
...
- - - - - - - - - - - - - -
@k_40_x*""",reply_markup=p3,parse_mode="markdown")
  p3 = types.InlineKeyboardMarkup()
